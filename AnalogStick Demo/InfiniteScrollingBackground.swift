...
class InfiniteScrollingBackground {
     ...
     */
    init?(images : [UIImage], scene : SKScene, scrollDirection : ScrollDirection, speed : TimeInterval, y : Float) {
    ...
    public func scrollRight(){
        ...
        for index in 0...numberOfSprites - 1 {
            ...
            let initialMovementAction = SKAction.moveTo(x: sprites[0].position.x  - sprites[0].size.width, duration: transitionDuration * Double(index + 1))
            let permanentMovementAction = SKAction.moveTo(x: sprites[0].position.x  - sprites[0].size.width, duration: transitionDuration * Double(numberOfSprites))
            if(index == 0){
                sprites[index].position = CGPoint(x: sprites[0].position.x - 0 , y: CGFloat(y))
                let putsImageOnTheRight = SKAction.moveTo(x: sprites[index].size.width/2 - (sprites[index].size.width * CGFloat(numberOfSprites - 1)), duration: 0.0)
            ...
            if(index == 1){
                sprites[index].position = CGPoint(x: sprites[0].position.x  - sprites[0].size.width , y: CGFloat(y))
                    let putsImageOnTheRight = SKAction.moveTo(x: sprites[index].size.width/2 - (sprites[index].size.width * CGFloat(numberOfSprites - 1)), duration: 0.0)
            ...
            //sprites[index].position = CGPoint(x: sprites[index].size.width/2 - (CGFloat(index) * sprites[index].size.width), y: CGFloat(y))
    ...
    public func scrollLeft(){
        ...
        let permanentMovementAction = SKAction.moveTo(x: -1 * sprites[index].size.width/2, duration: transitionDuration * Double(numberOfSprites))
            if(index == 0){
                sprites[index].position = CGPoint(x: sprites[0].position.x + 0 , y: CGFloat(y))
                 let putsImageOnTheLeft = SKAction.moveTo(x: sprites[index].position.x  - sprites[0].size.width, duration: 0.0)
                
                  let initialMovementAction = SKAction.moveTo(x: sprites[index].position.x  + sprites[0].size.width, duration: transitionDuration * Double(index + 1))
                
                  let permanentMovementAction = SKAction.moveTo(x: sprites[0].position.x  + sprites[0].size.width, duration: transitionDuration * Double(numberOfSprites))
            }
            if(index == 1){
                sprites[index].position = CGPoint(x: sprites[0].position.x  + sprites[0].size.width , y: CGFloat(y))
                 let putsImageOnTheLeft = SKAction.moveTo(x: sprites[0].position.x  + sprites[0].size.width, duration: 0.0)
